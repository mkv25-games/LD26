...
import net.mkv25.ld26.dbvos.GlobalRow;

class GlobalTable implements IDBVOTable
{
	public var dbvos(get, set):IDBVOsModel;
	var _dbvos:IDBVOsModel;

	public var rowList(get, never):Array<IDBVORow>;
	var _rowList:Array<GlobalRow>;
	...
	public function init():GlobalTable
	{
		_rowList = new Array<GlobalRow>();

		// code generated list of all rows
		var row1:GlobalRow = cast index(new GlobalRow(dbvos).init(1, "Walk Speed", 5, ""));
	...
	public function getRowCast(id:Int):GlobalRow
	{
